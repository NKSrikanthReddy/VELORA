        ...
        <main className="p-4 sm:p-8 max-w-5xl w-full mx-auto space-y-6">
          ...
          <div className="bg-teal-50/70 border border-teal-200/80 rounded-xl p-4 flex items-start gap-3 text-xs text-teal-900">
            ...
            <div className="leading-relaxed">
              <strong>Patient-Controlled Access:</strong> You hold full authority over your data. Doctors only receive temporary access while their code is valid. Revoking access terminates their session immediately.
            </div>
          </div>
